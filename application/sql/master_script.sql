...
ALTER TABLE `item` ADD CONSTRAINT `item_fk0` FOREIGN KEY (`i_u_id`) REFERENCES `user`(`u_id`);

ALTER TABLE `item` ADD CONSTRAINT `item_fk1` FOREIGN KEY (`i_c_id`) REFERENCES `category`(`c_id`);

ALTER TABLE `item_image` ADD CONSTRAINT `item_image_fk0` FOREIGN KEY (`ii_i_id`) REFERENCES `item`(`i_id`);
